...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      // API 연결 허용 대상
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.coingecko.com https://query1.finance.yahoo.com https://open.er-api.com https://www.googletagmanager.com https://analytics.google.com https://stats.g.doubleclick.net https://www.google-analytics.com",
      // GTM noscript iframe
