...
function Row({ item, isGainer }: { item: GainerLoserItem; isGainer: boolean }) {
  ...
  return (
    <div className={`flex items-center justify-between px-3 py-2 border-b border-gray-100 dark:border-slate-700/50 last:border-0 transition-colors ${isGainer ? "hover:bg-emerald-500/5" : "hover:bg-red-500/5"}`}>
    ...
    <section>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {data.gainers?.length > 0 && (
          <div className="rounded-2xl border border-slate-700/50 bg-white dark:bg-slate-800 overflow-hidden">
