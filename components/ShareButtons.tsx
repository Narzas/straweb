    ...
    <div className="flex items-center gap-2 flex-wrap">
      ...
      {canNativeShare && (
        <button
          ...
          title="공유하기"
          className="flex items-center gap-1.5 rounded-full border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-300 hover:border-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
        >
